...
public class Profile_my_profile_page_objects {
	...
	public boolean super_admin_logger_my_profile_change_passoword_button_should_be_displayed(){
		return change_password_button.isDisplayed();
	}
	
	public boolean super_admin_logger_my_profile_change_passoword_button_should_be_clickable(){
		return change_password_button.isEnabled();
	}
	
	public void super_admin_logger_my_profile_change_passoword_button_clicked(){
		 change_password_button.click();
	}
	
	public boolean super_admin_logger_my_profile_change_password_button_should_be_able_to_mouse_hover(){
	...
	public boolean super_admin_logger_my_profile_first_name_asterisk_sign_should_be_displayed() {
		return my_profile_first_name_asterisk_sign.isDisplayed();
	}

	public boolean super_admin_logger_my_profile_last_name_asterisk_sign_should_be_displayed() {
		return my_profile_last_name_asterisk_sign.isDisplayed();
	}

	public boolean super_admin_logger_my_profile_email_asterisk_sign_should_be_displayed() {
		return my_profile_email_asterisk_sign.isDisplayed();
	}

	public boolean super_admin_logger_my_profile_mobile_number_asterisk_sign_should_be_displayed() {

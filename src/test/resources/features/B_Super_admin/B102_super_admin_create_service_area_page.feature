...
#Feature: Validate super admin create service area page functionality
 ...
 #
 #@Smoke
  #Scenario:  Validate that elemets is present with super admin user in super admin create service area page
  #Given Verify that super admin user is on users create service area page as expected page title is "Shield"

...
public class B042_super_admin_my_profile_change_password_page {
	...
	Logger logger = LogManager.getLogger(B042_super_admin_my_profile_change_password_page.class);
    ...
    public void verify_that_user_is_on_the_super_admin_profile_change_password_page_as_expected_page_title(String title) {
		...
		smp.super_admin_logger_my_profile_change_passoword_button_clicked();

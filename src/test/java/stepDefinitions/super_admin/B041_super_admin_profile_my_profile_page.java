...
public class B041_super_admin_profile_my_profile_page {
	...
	Logger logger = LogManager.getLogger(B041_super_admin_profile_my_profile_page.class);
    ...
    public void verify_that_change_passoword_button_should_be_displayed_in_the_super_admin_my_profile_page() {
    	boolean actual=saprof.super_admin_logger_my_profile_change_passoword_button_should_be_displayed();
        Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
    ...
    public void verify_that_change_password_button_should_be_clickable_in_the_super_admin_my_profile_page() {
    	boolean actual=saprof.super_admin_logger_my_profile_change_passoword_button_should_be_clickable();
        Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
    ...
    public void verify_that_change_password_button_should_be_able_to_mouse_hover_in_the_super_admin_my_profile_page() {
    	boolean actual=saprof.super_admin_logger_my_profile_change_password_button_should_be_able_to_mouse_hover();
        Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_first_name_asterisk_sign_should_be_displayed_in_the_super_admin_profile_page() {
		boolean actual = saprof.super_admin_logger_my_profile_first_name_asterisk_sign_should_be_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_last_name_asterisk_sign_should_be_displayed_in_the_super_admin_profile_page() {
		boolean actual = saprof.super_admin_logger_my_profile_last_name_asterisk_sign_should_be_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_email_asterisk_sign_should_be_displayed_in_the_super_admin_profile_page() {
		boolean actual = saprof.super_admin_logger_my_profile_email_asterisk_sign_should_be_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_mobile_number_asterisk_sign_should_be_displayed_in_the_super_admin_my_profile_page() {
		boolean actual = saprof.super_admin_logger_my_profile_mobile_number_asterisk_sign_should_be_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}

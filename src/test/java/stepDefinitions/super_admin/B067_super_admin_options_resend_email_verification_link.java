...
public class B067_super_admin_options_resend_email_verification_link {
	...
	Logger logger = LogManager.getLogger(B067_super_admin_options_resend_email_verification_link.class);
	...
	public void verify_that_super_admin_search_button_is_able_to_search_the_user_with_name_of_user_in_all_users_page_for_resend_email_verification_link() {
	    saalluser.super_admin_user_all_users_search_userfield_sendText(AppHooks.tdata.getProperty("search_admin"));
